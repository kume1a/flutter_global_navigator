...
class SnackbarController {
  ...
  final GlobalKey<GNSnackBarState> key = GlobalKey<GNSnackBarState>();

  late Animation<double> _filterBlurAnimation;
  late Animation<Color?> _filterColorAnimation;

  final GNSnackBar snackbar;
  ...
  Animation<double> _createBlurFilterAnimation() {
    return Tween<double>(begin: 0.0, end: snackbar.overlayBlur).animate(
      CurvedAnimation(
        parent: _controller,
...
class _SnackBarQueue {
  final SimpleQueue _queue = SimpleQueue();
